...
@file: cluener_bertcrf_exp.py
@time: 2022/2/23 1:46 PM
@desc: 
"""
...
def cluener_bert_crf_exp(hypers):
    ...
    # 2.initialize the bert_crf model, tokenizer
    bert_tokenizer = create_pretrained_tokenizer(model_type=pretrain_model_type)

    bert_crf = create_ner_model(ner_model='BERTCRF',
    ...
    analyzer.analysis_experiment(exp_result_dir=trainer.exp_result_dir,title="Cluener_BERTCRF_Experiment")

if __name__ == '__main__':
    hypers = parse_parmas()
    cluener_bert_crf_exp(hypers)
